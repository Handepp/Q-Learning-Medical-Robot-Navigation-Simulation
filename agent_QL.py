"""
Brain of the RL agent (Q-Learning Algorithm)
...
class RL:
    def __init__(self, actions, states):
        ...
        # create the Q-table (index:49 states   columns: 4 actions)
        self.q_table = pd.DataFrame(np.zeros((49, 4)), index=self.states, columns=self.actions, dtype=np.float64)
...
class QLearningTable(RL):
    ...
    def update_table(self, s, a, r, s_):
        ...
        if (s_ != [150, 350] or s_ != [350, 450] or s_ != [550, 250] or s_ != [350, 250]
        or s_ != [250, 50]or s_ != [350, 50]or s_ != [50, 550]or s_ != [350, 650]or s_ != [550, 550]
        or s_ != [650, 350]or s_ != [50, 350]or s_ != [150, 550]):
